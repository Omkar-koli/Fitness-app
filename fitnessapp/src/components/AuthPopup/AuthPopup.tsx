    ...
    <div className='popup'>
        ...
        showSignup ? (
            <div className='authform'>
                ...
                <div className='right'>
                    <h1>SignUp to join a Revolution</h1>
                    <form action="">
                        <Input 
                            color="primary"
                            placeholder="name"
                        ...
                        />
                        <Input 
                                color="primary" size="lg" variant="soft" type="number" placeholder='Weight in kg'
                                onChange={(e) => {
                                    setSignupFormData({
                                        ...signupformData,
                        ...
                        <Input color="primary" size="lg" variant="soft" type="number" placeholder='cm'
                        onChange={(e) => {
                            setSignupFormData({
                                ...signupformData,
            ...
            <div className='authform'>
                ...
                <div className='right'>
                    <h1>Login to join a Revolution</h1>
                    <form action="">
                        <Input 
                            color="primary"
                            placeholder="email"
